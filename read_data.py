...
body_part_names_xsens = ["Head", "Hips", "LeftShoulder", "LeftToe", "LeftElbow", "LeftWrist", "LeftKnee", "LeftHip", "Neck",
                   "RightShoulder"
...
# read data of Motionet video and prepare two csv file contain all joints for translation and rotation for each frame
