from body_part_reba_calculator.neck_score import neck_score
from body_part_reba_calculator.trunck_score import trunk_score
from body_part_reba_calculator.leg_score import leg_score
from body_part_reba_calculator.upper_arm_score import upper_arm_score
from body_part_reba_calculator.lower_arm_score import lower_arm_score
# from body_part_reba_calculator.wrist_score import wrist_score
import draw
import numpy as np
...
# this is the file that the angle of each body part is calculating that will be used for REBA calculation
file = open("body_angle_value.txt", "w")

for i in range(1,9):
    string = "joints" + str(i) + ".txt"
    joints = np.loadtxt(string)
    ...
    # step 9: wrist score - but the proble
    ...
    # for printing each part of REBA score
